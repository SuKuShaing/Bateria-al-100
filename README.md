...
- **🪟 Windows (10/11):**<br><a href="https://apps.microsoft.com/detail/9NKTXXC7PJHR" target="_blank"><img src="https://get.microsoft.com/images/en-us%20dark.svg" width="160" alt="Get it from Microsoft"/></a><br><br>_Instaladores directos (GitHub Releases):_ [⬇️ Descargar .exe](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/BateriaAlCien_0.1.15_x64-setup.exe) / [⬇️ Descargar .msi](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/BateriaAlCien_0.1.15_x64_en-US.msi)

- **🍎 macOS (Apple Silicon / Intel):** [⬇️ Descargar .dmg](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/BateriaAlCien_0.1.15_aarch64.dmg)
- **🐧 Linux (Ubuntu/Debian):** [⬇️ Descargar .deb](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/BateriaAlCien_0.1.15_amd64.deb) / [⬇️ Descargar AppImage](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/BateriaAlCien_0.1.15_amd64.AppImage)
