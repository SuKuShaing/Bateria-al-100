...
- **🪟 Windows (10/11):** [⬇️ Descargar .exe](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/bateriaAlCien_0.1.7_x64-setup.exe) / [⬇️ Descargar .msi](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/bateriaAlCien_0.1.7_x64_en-US.msi)
- **🍎 macOS (Apple Silicon / Intel):** [⬇️ Descargar .dmg](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/bateriaAlCien_0.1.7_aarch64.dmg)
- **🐧 Linux (Ubuntu/Debian):** [⬇️ Descargar .deb](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/bateriaAlCien_0.1.7_amd64.deb) / [⬇️ Descargar AppImage](https://github.com/SuKuShaing/Bateria-al-100/releases/latest/download/bateriaAlCien_0.1.7_amd64.AppImage)
